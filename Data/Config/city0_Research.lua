...
x805026_g_Name	="Bang Hµi ÐÕi T±ng Quän"
...
x805026_g_MissionTarget="Cho ðÕi t±ng quän bang hµi 5 ð°ng ti«n"
x805026_g_MissionContinue="Các hÕ ðã có ðü 5 ð°ng ti«n chßa?"
x805026_g_MissionComplete="  », làm khá l¡m. Xem ra các hÕ có nhi«u ti«n l¡m ð¤y"
x805026_g_MoneyBonus=0
x805026_g_SignPost = {x = 109, z = 167, tip = "Bang Hµi ÐÕi T±ng Quän"}
