...
x210205_g_MissionTarget="— #Gthành ÐÕi Lý Ngû Hoa Ðàn#W tìm 1 trong TÑ ÐÕi Thiên Nhân #R Ti«n Long#W#{_INFOAIM145,139,2,Ti«n Long}. #b#G (Dùng chuµt trái nh¤p vào t÷a ðµ, có th¬ giúp các hÕ tìm ðßþc NPC) #l"
x210205_g_MissionComplete="#{event_dali_0009}"
x210205_g_MoneyBonus=1
x210205_g_SignPost = {x = 145, z = 138, tip = "Ti«n Long"}
x210205_g_Custom	= { {id="Ðã tìm ðßþc Ti«n Long",num=1} }
