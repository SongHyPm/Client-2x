...
x210209_g_MissionInfo="  Ði tìm ð® tØ 10 môn phái h÷c 1 kÛ nång"
...
{name="ThÕch Bäo",			skill="H÷c Ph¤n Lñc Ðä Kích"},
...
{name="Trình Thanh Sß½ng",		skill="H÷c S½ C¤p †n Ðµn"},
{name="Ðàm Ðài TØ Vû",	skill="H÷c Nhiên Thiêu Hãm Tïnh"},
{name="Mµ Dung truy«n",	  skill="H÷c Tinh Tuy«n Phän Kích"},  --newmenpai
}
--MisDescEnd
