...
x210212_g_MissionTarget="    V« #GNgû Hoa Ðàn thành ÐÕi Lý#W tìm#R Tri®u Thiên Sß #W#{_INFOAIM160,157,2,Tri®u Thiên Sß}. #b#G (Dùng chuµt trái nh¤p vào t÷a ðµ, có th¬ giúp các hÕ tìm ðßþc NPC) #l"
...
x210212_g_Custom	= { {id="Ðã tìm th¤y Tri®u Thiên Sß",num=1} }
--MisDescEnd
