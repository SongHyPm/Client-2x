...
x210203_g_MissionTarget="— #Gthành ÐÕi Lý ðß¶ng l¾n phía Tây#W có#Y Ti®m Dßþc#W hãy tìm ðªn #RLô Tam Th¤t#W#{_INFOAIM103,132,2,Lô Tam Th¤t}. #b#G (Dùng chuµt trái nh¤p vào t÷a ðµ, có th¬ giúp các hÕ tìm ðßþc NPC) #l"
x210203_g_MissionComplete="  Không ng¶ các hÕ có hÑng thú sâu s¡c nhß v§y v¾i y ðÕo, ðßþc ðàm ðÕo v¾i các hÕ th§t thoäi mái. Ch² #Ydßþc ph¦m#W này các hÕ hãy ch÷n l¤y mµt, hãy coi ðó là món quà di®n kiªn ta t£ng các hÕ"
...
x210203_g_Custom	= { {id="Ðã tìm ðßþc Lô Tam Th¤t",num=1} }
