...
x050220_g_Custom	= { {id="Ğã giªt chªt:#r Huy«n Lôi Pha Th± Phï",num=60},{id="  Ngßu Khúc",num=1},{id="  Ngßu KÏ",num=1},{id="  Vß½ng Diêm",num=1},{id="Ğã tìm th¤y: #r Hoàng Kim Chi Liên",num=1} }
--MisDescEnd
