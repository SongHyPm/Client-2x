...
x200031_g_Custom	= { {id="Ðã løc soát S· Vß½ng ðÕi doanh",num=1}, {id="Ðã løc soát ngân kh¯ riêng cüa Hoàng TháiThúc",num=1}, {id="Ðã løc soát ðß¶ng phía Ðông núi Thß½ng Mang",num=1}, {id="Ðã løc soát ðß¶ng phía Tây núi Thß½ng Mang",num=1} }
--MisDescEnd
