...
x001230_g_nMenpaiShiZhuang = {{id=10124009,name="Không s¡c"},
...
x001230_g_nCailiaoJiangli	 = {{id=20500000,name="Tinh Thiªt Toái Phiªn"},
...
BeginEvent(sceneId)
AddText(sceneId,"#BHoa S½n lu§n kiªm");
AddText(sceneId,"  Hi®n không phäi là th¶i gian báo danh tham gia Hoa S½n lu§n kiªm, ðþi ðªn khi b¡t ð¥u cüa HoÕt ðµng hãy ðªn tìm ta");
EndEvent(sceneId)
DispatchEventList(sceneId,selfId,targetId)
return
end
...
BeginEvent(sceneId)
local strText = "Các hÕ ðã t×ng nh§n lînh ph¥n thß·ng, hãy tiªp tøc c¯ g¡ng, l¥n sau th¡ng m¾i tìm ta."
...
BroadMsgByChatPipe(sceneId,0,"@*;SrvMsg;SCA:" .. "#PTrong vòng Hoa S½n Lu§n Kiªm này, #Y" .. x001230_g_bMenpai .. "#PTräi qua trên dß¾i không biªt bao nhiêu khó khån, cu¯i cùng cûng vinh dñ ðÕt ðßþc #YHoa S½n Lu§n Kiªm hÕng nh¤t#P, ð¬ ðµng viên ð® tØ quý phái cho sñ ki®n này, thì t× nay ðªn khi kªt thúc vòng sau Hoa S½n Lu§n Kiªm, m²i ngày vòng nhi®m vø ð¥u tiên s¨ #Y thß·ng kinh nghi®m g¤p 3 l¥n.",4)
local mingci = 1		
local str = ""		
for i=1, x001230_g_PlayerNum  do				
if mingci == 1  then
str = "Giäi nh¤t: " .. x001230_g_PlayerName[i]
mingci = 2					
elseif mingci == 2  then
str = "Giäi nhì: " .. x001230_g_PlayerName[i]						
mingci = 3											
elseif mingci == 3  then
str = "Giäi ba: " .. x001230_g_PlayerName[i]
mingci = 4
elseif mingci == 4  then
str = "Giäi tß: " .. x001230_g_PlayerName[i]
mingci = 5					
elseif mingci == 5  then
str = "Giäi nåm: " .. x001230_g_PlayerName[i]
mingci = 6							
...
local nMingci = 1
local szStr = "Dß¾i ðïnh Hoa S½n, thiên hÕ môn phái tr± tài th¬ hi®n. Trß¾c m¡t xét v« thñc lñc, môn phái ðÑng nh¤t nhì ba, phân bi®t là: "
...
szStr = szStr .. "Các ðÕi hi®p hi®p næ cüa các môn phái khác c¥n n² lñc nhi«u h½n"
...
mailStr = "Chúc m×ng b¢ng hæu ðã giành giäi nh¤t trong cuµc thi Hoa S½n Lu§n Kiªm ! B¢ng hæu có th¬ ðªn tìm ngß¶i chü trì  Hoa S½n Lu§n Kiªm Tô Kiªm Lînh (Tô Châu 193, 138) nh§n lînh ph¥n thß·ng phong phú! Chú ý: Th¶i gian nh§n lînh ph¥n thß·ng là 1 tiªng, quá 1 tiªng không th¬ nh§n lînh ðßþc mà phäi ðþi vòng sau ! Khi nh§n thß·ng phäi nh¤p vào ô xác nh§n lãnh thß·ng, sau khi l¤y ðßþc giäi thß·ng qua bßu ki®n, nh¤p vào giäi thß·ng Hoa S½n Lu§n Kiªm là có th¬ thành công lãnh thß·ng."
...
mailStr = "Chúc m×ng b¢ng hæu ðã giành giäi nhì trong cuµc thi \"Hoa S½n Lu§n Kiªm\" ! B¢ng hæu có th¬ ðªn tìm Ngß¶i Chü Trì  Hoa S½n Lu§n Kiªm Tô Kiªm Lînh (Tô Châu 193, 138) nh§n lînh ph¥n thß·ng phong phú! Chú ý: Th¶i gian nh§n lînh ph¥n thß·ng là 1 tiªng, quá 1 tiªng không th¬ nh§n lînh ðßþc mà phäi ðþi vòng sau ! Khi nh§n thß·ng phäi nh¤p vào ô xác nh§n lãnh thß·ng, sau khi l¤y ðßþc giäi thß·ng qua bßu ki®n, nh¤p vào giäi thß·ng Hoa S½n Lu§n Kiªm là có th¬ thành công lãnh thß·ng."
local StartTime = LuaFnGetCurrentTime()
local nMonth = LuaFnGetThisMonth()
local nDay   = LuaFnGetDayOfThisMonth()
local nData  = (nMonth+1)*100+nDay						
...
mailStr = "Chúc m×ng b¢ng hæu ðã giành giäi ba trong cuµc thi \"Hoa S½n Lu§n Kiªm\" ! B¢ng hæu có th¬ ðªn tìm Ngß¶i Chü Trì  Hoa S½n Lu§n Kiªm Tô Kiªm Lînh (Tô Châu 193, 138) nh§n lînh ph¥n thß·ng phong phú! Chú ý: Th¶i gian nh§n lînh ph¥n thß·ng là 1 tiªng, quá 1 tiªng không th¬ nh§n lînh ðßþc mà phäi ðþi vòng sau ! Khi nh§n thß·ng phäi nh¤p vào ô xác nh§n lãnh thß·ng, sau khi l¤y ðßþc giäi thß·ng qua bßu ki®n, nh¤p vào giäi thß·ng Hoa S½n Lu§n Kiªm là có th¬ thành công lãnh thß·ng."
local StartTime = LuaFnGetCurrentTime()
local nMonth = LuaFnGetThisMonth()
local nDay   = LuaFnGetDayOfThisMonth()
local nData  = (nMonth+1)*100+nDay						
...
for i=1, 9  do
str = "#PVòng Hoa S½n Lu§n Kiªm này ðã kªt thúc, các ð°ng môn ðã c¯ g¡ng ch¤n hßng môn phái, trong chiªn ð¤u n² lñc hªt mình, trong s¯ h÷ thì ngß¶i có ði¬m cao nh¤t là :#W"
...
mailStr = "Chúc m×ng b¢ng hæu ðã giành giäi nh¤t môn phái trong cuµc thi \"Hoa S½n Lu§n Kiªm\" ! B¢ng hæu có th¬ ðªn tìm Ngß¶i Chü Trì  Hoa S½n Lu§n Kiªm Tô Kiªm Lînh (Tô Châu 193, 138) nh§n lînh ph¥n thß·ng phong phú! Chú ý: Th¶i gian nh§n lînh ph¥n thß·ng là 1 tiªng, quá 1 tiªng không th¬ nh§n lînh ðßþc mà phäi ðþi vòng sau ! Khi nh§n thß·ng phäi nh¤p vào ô xác nh§n lãnh thß·ng, sau khi l¤y ðßþc giäi thß·ng qua bßu ki®n, nh¤p vào giäi thß·ng Hoa S½n Lu§n Kiªm là có th¬ thành công lãnh thß·ng."
local StartTime = LuaFnGetCurrentTime()
local nMonth = LuaFnGetThisMonth()
local nDay   = LuaFnGetDayOfThisMonth()
local nData  = (nMonth+1)*100+nDay						
...
mailStr = "Chúc m×ng b¢ng hæu ðã giành giäi nhì môn phái trong cuµc thi \"Hoa S½n Lu§n Kiªm\" ! B¢ng hæu có th¬ ðªn tìm Ngß¶i Chü Trì  Hoa S½n Lu§n Kiªm Tô Kiªm Lînh (Tô Châu 193, 138) nh§n lînh ph¥n thß·ng phong phú! Chú ý: Th¶i gian nh§n lînh ph¥n thß·ng là 1 tiªng, quá 1 tiªng không th¬ nh§n lînh ðßþc mà phäi ðþi vòng sau ! Khi nh§n thß·ng phäi nh¤p vào ô xác nh§n lãnh thß·ng, sau khi l¤y ðßþc giä thß·ng qua bßu ki®n, nh¤p vào giäi thß·ng Hoa S½n Lu§n Kiªm là có th¬ thành công lãnh thß·ng."
local StartTime = LuaFnGetCurrentTime()
local nMonth = LuaFnGetThisMonth()
local nDay   = LuaFnGetDayOfThisMonth()
local nData  = (nMonth+1)*100+nDay						
...
mailStr = "Chúc m×ng b¢ng hæu ðã giành giäi ba môn phái trong cuµc thi \"Hoa S½n Lu§n Kiªm\" ! B¢ng hæu có th¬ ðªn tìm Ngß¶i Chü Trì  Hoa S½n Lu§n Kiªm Tô Kiªm Lînh (Tô Châu 193, 138) nh§n lînh ph¥n thß·ng phong phú! Chú ý: Th¶i gian nh§n lînh ph¥n thß·ng là 1 tiªng, quá 1 tiªng không th¬ nh§n lînh ðßþc mà phäi ðþi vòng sau ! Khi nh§n thß·ng phäi nh¤p vào ô xác nh§n lãnh thß·ng, sau khi l¤y ðßþc giä thß·ng qua bßu ki®n, nh¤p vào giäi thß·ng Hoa S½n Lu§n Kiªm là có th¬ thành công lãnh thß·ng."
local StartTime = LuaFnGetCurrentTime()
local nMonth = LuaFnGetThisMonth()
local nDay   = LuaFnGetDayOfThisMonth()
local nData  = (nMonth+1)*100+nDay						
...
BeginEvent(sceneId)
AddText(sceneId, "#PSñ ki®n Hoa S½n Lu§n Kiªm kªt thúc.")
EndEvent()
...
if IsAddCnt == 0 then
BeginEvent(sceneId)
AddText(sceneId, "Do các hÕ giªt chªt cùng 1 ngß¶i ch½i ho£c ngß¶i ch½i ðó có ðÆng c¤p cách bi®t v¾i các hÕ h½n 40 c¤p, các hÕ s¨ không nh§n ðßþc ði¬m c¯ng hiªn môn phái và tính ph¥n thß·ng.")
EndEvent(sceneId)
