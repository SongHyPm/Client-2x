...
x808010_g_FormatList = {"Ðµi phu thê 2 ngß¶i hãy ðªn%s, %s, %s, thu th§p Tiên Linh Khí b¢ng H° Lô Nguy®t Lão r°i hãy mang v« ðây.",}
x808010_g_StrList = {
"BÕch Viên ThÕch Tr§n · Vô Lßþng S½n#{_INFOAIM53,264,6,}",
"Kiªm Môn Ði®p Thuý · Kiªm Các#{_INFOAIM130,135,7,}",
"Hãn Häi C¥u Ph§t · Ðôn Hoàng #{_INFOAIM260,260,8,}",
"Ng÷c Ð¾i Lâm Phong · Kính H° #{_INFOAIM39,261,5,}",
"Vû TÕ Ca Ðài · Thái H° #{_INFOAIM160,252,4,}",
"Giang S½n Ða Ki«u · Tung S½n #{_INFOAIM275,85,3,}",
"Nh¤t V÷ng H± Bào · Tây H° #{_INFOAIM170,235,30,}",
"Bách Khä Tranh Lßu · Nh¸ Häi #{_INFOAIM260,270,24,}",
"Phong Ki«u T¸ch Chiªu · NhÕn Nam #{_INFOAIM150,250,18,}",
"Phi Lßu Trñc HÕ · Long Tuy«n #{_INFOAIM270,280,31,}",
"Tñ ThuÖ Niên Hoa · Thß½ng S½n #{_INFOAIM258,73,25,}",
