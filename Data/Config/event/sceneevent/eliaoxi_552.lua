...
x212107_g_Custom	= { {id="Ðã ð¯t phân sói khô",num=1} }
x212107_g_MissionName="Ðu±i theo H¡c Phong"
x212107_g_MissionInfo="#{Lua_liaoxi_001}"
x212107_g_MissionTarget="  Giªt chªt #RBÕch Lang Vß½ng #W#{_INFOAIM161,268,21,-1}, ðÕt ðßþc Can Lang Ph¥n. Dùng lØa ð¯t Can Lan Ph¥n, ðu±i hªt H¡c Phong, sau ðó quay lÕi #GQuäng Ninh Tr¤n#W tìm #RBá Nhan #W#{_INFOAIM164,199,21,Bá Nhan} báo cáo phát hi®n cüa mình."
