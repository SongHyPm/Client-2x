...
x500621_g_SceneID=0
x500621_g_AccomplishNPC_Name="B鄋h Ho鄆 Ng鱟"
x500621_g_MissionId = 1187
x500621_g_Name	="B鄋h Ho鄆 Ng鱟"
...
x500621_g_SignPost = {x = 177, z = 184, tip = "B鄋h Ho鄆 Ng鱟"}
x500621_g_ItemBonus={{id=50213004 ,num=1},{id=20109004,num=1},{id=10413096,num=1}}
x500621_g_Custom	= { {id="秀 t靘 疬㧟 B鄋h Ho鄆 Ng鱟",num=1} }
x500621_g_IsMissionOkFail = 1		--变量的第0位
--MisDescEnd
