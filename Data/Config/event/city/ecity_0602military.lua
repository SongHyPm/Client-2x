...
x600032_g_MissionTarget = "    Ğ® tØ bang ta%s%1s, ğã có ğßşc thông tin quan trong thành này, các hÕ mau ği tìm %2n, ông ¤y s¨ giúp ğŞ cho hành ğµng cüa chúng ta.#r#{BHRW_091224_1}"	--ÈÎÎñÄ¿±ê
