...
"",
"    Dña vào manh m¯i tìm ra Nµi QuÖ và l¤y ğßşc %2i, giao cho %1n.#r#{BHRW_091224_1}",			--1 ¸±±¾ÖĞ´ò³öÅä·½
"    L¤y %2i mà ğÕt ğßşc, giao cho %1n.#r#{BHRW_091224_1}",						--2 ÕÒµ½NPC
"    Nhi®m vø hoàn thành, có th¬ ğªn ch² ğÕi t±ng quän cüa bang hµi nh§n ph¥n thß·ng.#r#{BHRW_091224_1}"		--3 ËÍ»¹
}
