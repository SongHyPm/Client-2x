...
x600009_g_MissionTarget = "    Hµ t¯ng %n ğªn g¥n %s%s .#r#{BHRW_091224_1}"	--ÈÎÎñÄ¿±ê
x600009_g_ContinueInfo = "    Nhi®m vø cüa các hÕ vçn chßa hoàn thành à?"						--Î´Íê³ÉÈÎÎñµÄnpc¶Ô»°
x600009_g_SubmitInfo = "    Sñ tình tiªn tri¬n nhß thª nào r°i?"								--Íê³ÉÎ´Ìá½»Ê±µÄnpc¶Ô»°
x600009_g_MissionComplete = "    Làm t¯t l¡m, r¤t t¯t r¤t t¯t. "						--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
