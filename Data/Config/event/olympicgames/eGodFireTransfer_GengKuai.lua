...
x808100_g_AccomplishNPC_Name="Ðao Nghiêu"
x808100_g_MissionId			= 1006
x808100_g_MissionIdNext	= 1007
x808100_g_Name 					= "Ðao Nghiêu"
x808100_g_MissionKind			= 13
x808100_g_MissionLevel		= 10
x808100_g_IfMissionElite	= 0
x808100_g_IsMissionOkFail	= 0		--ÈÎÎñ²ÎÊýµÄµÚ0Î»
x808100_g_MissionName			= "Thánh Höa chuy¬n tiªp nhanh h½n"
...
x808100_g_Custom	= { {id="Ðã ðánh bÕi Bài C¥u",num=5}, {id="Ðã ðánh bÕi Ti¬u Nh¸ Nh¸",num=1} }
--MisDescEnd
