...
local g_Conditions = {
	MenPai = {"Thiªu Lâm", "Minh Giáo", "Cái Bang", "Võ Ðang", "Nga My", "Tinh Túc", "Thiên Long", "Thiên S½n", "Tiêu Dao", "Không có", "Toàn bµ"},
	...
	Banghui = {"Toàn bµ", "Có bang phái", "Không bang phái"},
	ADType	= {"Toàn bµ", "Kªt Hôn", "Bang Hµi", "Sß Ð°", "Kªt Nghîa"},   -- ´Ë´¦ÓÃ×Öµä²»ÐÐ£¬ÁÐ±í¿òºÃÏñ²»Ö§³Ö {"È«²¿", "#{ZYPT_081103_008}", "#{ZYPT_081103_009}", "#{ZYPT_081103_010}", "#{ZYPT_081103_011}",},
	HotLevel = {"Toàn bµ", "0-10", "11-20", "21-30", "31-40", "41-50", "51-60", "61-70", "71-80"},
}
...
function ZhengyouSearch_BeginSearch()
	...
	--·¢ËÍ²éÕÒÇëÇó
	--×¢Òâ£º ÃÅÅÉµÄÈ«²¿ºÍÆäËü²»Ò»Ñù£¬ÆäËü¶¼ÊÇ0£¬ ¶øÃÅÅÉÎª10²ÅÊÇÈ«²¿ 
