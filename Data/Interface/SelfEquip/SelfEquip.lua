...
function SelfEquip_OnLoad()
	...
	g_WUHUN		 = SelfEquip_18;		--Îä»ê 	
	g_LONGWEN    = SelfEquip_25;		--ÁúÎÆ	
...
function Equip_RefreshEquip()
	...
	g_WUHUN:SetActionItem(-1);			--Îä»ê	
	g_LONGWEN:SetActionItem(-1);		--ÁúÎÆ
	...
	g_WUHUN:SetActionItem(ActionWuhun:GetID());			--Îä»ê	
	g_LONGWEN:SetActionItem(ActionLongwen:GetID());		--ÁúÎÆ
...
function SelfEquip_Equip_Click( nTypeIn,buttonIn )
	...
	elseif( nType == 18 ) then
		if( button == 1 ) then
			g_WUHUN:DoAction();	--Îä»ê
		else
			g_WUHUN:DoSubAction();	--Îä»ê
		end		
	elseif( nType == 25 ) then
		if( button == 1 ) then
			g_LONGWEN:DoAction();	--ÁúÎÆ
		else
			g_LONGWEN:DoSubAction();	--ÁúÎÆ
		end
	end
end
...
function SelfEquip_Accept_Click()
	...
	--AxTrace( 0,0, "Ç±ÄÜµãÊý"..tostring( g_AddStr ).."\n"..tostring( g_AddSpr ).."\n"..tostring( g_AddCon ).."\n"..tostring( g_AddInt ).."\n"..tostring(g_AddDex));
...
function SelfEquip_SetStateTooltip()
	...
	SelfEquip_IceFastness:SetToolTip("Bång công:"..tostring(iIceAttack).."#rKháng Bång:"..tostring(iIceDefine).."#rGiäm kháng Bång:"..tostring(iIceResistOther) );
	SelfEquip_FireFastness:SetToolTip("Höa công:"..tostring(iFireAttack).."#rKháng Höa:"..tostring(iFireDefine).."#rGiäm kháng Höa:"..tostring(iFireResistOther) );
	SelfEquip_ThunderFastness:SetToolTip("Huy«n công:"..tostring(iThunderAttack).."#rKháng Huy«n:"..tostring(iThunderDefine).."#rGiäm kháng Huy«n:"..tostring(iThunderResistOther) );
	SelfEquip_PoisonFastness:SetToolTip("Ðµc công:"..tostring(iPoisonAttack).."#rKháng Ðµc:"..tostring(iPoisonDefine).."#rGiäm kháng Ðµc:"..tostring(iPoisonResistOther) );
