...
function TargetEquip_OnLoad()
	...
	g_Wuhun	= TargetEquip_Equip16;		-- Ê±×°
	g_LongWen		= TargetEquip_Equip25;		-- ÁúÎÆ
...
function TargetEquip_RefreshEquip()
	...
	local ActionWuhun		= EnumAction(18, "targetequip");
	local ActionLongWen		= EnumAction(19, "targetequip");
	...
	g_LongWen:SetActionItem(ActionLongWen:GetID());-- Ê±×°
