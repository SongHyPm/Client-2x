...
function YuanbaoShop_OnLoad()
	...
	SHOP_LIST_A[1].shoplist[4] = "Thành Th¸ ÐÕi Lý"
	SHOP_LIST_A[1].shoplist[5] = "Thành Th¸ LÕc Dß½ng"
	SHOP_LIST_A[1].shoplist[6] = "Thành Th¸ Tô Châu"
	SHOP_LIST_A[1].shoplist[7] = "Thành Th¸ Lâu Lan"
	SHOP_LIST_A[1].shoplist[8] = "Shop thú cßÞi m¾i"
...
--	SHOP_LIST_A[2].shoplist[1] = "#{YBSD_081225_022}"	--"´óÀí±¦Ê¯Õ«";
	...
	SHOP_LIST_A[2].shoplist[4] = "Bäo ThÕch Tinh Hoa"
