...
x200015_g_MissionComplete="  $N, ½n cÑu mÕng cüa các hÕ, tÕi hÕ nh¤t ð¸nh s¨ báo ðáp. Nhßng mà, tÕi hÕ thi®n gi¶ thân trúng k¸ch ðµc... không biªt làm sao ð¬ có c½ hµi báo ðáp..."	--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
...
x200015_g_Custom	= { {id="Ðã giªt Hoàng H° TØ",num=1} ,{id="Ðã giªt Hôi Bào Khách",num=1},{id="Ðã giªt ð® tØ H± Träo Môn",num=1},{id="Ðã giªt C¥u Nhiêm Võ Sî",num=1},{id="Ðã giªt Cao Thü Ð¤u V§t",num=1}}
--MisDescEnd
