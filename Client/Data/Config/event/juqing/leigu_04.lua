...
x200043_g_MissionTarget="#{Mis_juqing_Tar_0036}"	--ÈÎÎñÄ¿±ê
x200043_g_MissionComplete="  Các hÕ r¯t cuµc ðã ðªn r°i, hãy mau ði chu¦n b¸ ði, tr§n chiªn v¾i Ðinh Xuân Thu l¥n này, Hung hi¬m vô bì"	--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
x200043_g_MoneyBonus=8100
x200043_g_exp=20000
x200043_g_Custom	= { {id="Ðã tìm ðßþc Tô Tinh Hà",num=1} }
--MisDescEnd
