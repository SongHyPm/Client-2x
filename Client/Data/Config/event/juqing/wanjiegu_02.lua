...
x200002_g_Name = "Ðoàn Chính Thu¥n"
...
x200002_g_MissionTarget="#{Mis_juqing_Tar_0005}"	--ÈÎÎñÄ¿±ê
x200002_g_MissionComplete="  $N, các hÕ r¯t cuµc ðã ðªn r°i, chúng ta ðã ðþi các hÕ ðã lâu r°i. "	--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
x200002_g_MoneyBonus=10
x200002_g_exp=1500
x200002_g_Custom	= { {id="Ðã tìm ðßþc Ðoàn Chính Thu¥n",num=1} }
--MisDescEnd
