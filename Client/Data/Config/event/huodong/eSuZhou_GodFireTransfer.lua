...
x808081_g_SceneID=1
x808081_g_AccomplishNPC_Name="Løc Sî Tranh"
x808081_g_MissionId			= 1000
x808081_g_MissionIdNext	= 1000
x808081_g_Name 					= "Løc Sî Tranh"
x808081_g_MissionKind			= 13
x808081_g_MissionLevel		= 20
x808081_g_IfMissionElite	= 0
x808081_g_IsMissionOkFail	= 0		--ÈÎÎñ²ÎÊýµÄµÚ0Î»
x808081_g_MissionName			= "Nhi®m vø Quy Th¯ ChÕy Ðua"
...
x808081_g_Custom	= { {id="Ðã ð¯i thoÕi v¾i LÕc Dß½ng Tri®u Minh Thành",num=1}, {id="Ðã ð¯i thoÕi v¾i Tô Châu Løc Sî Tranh",num=1}, {id="Ðã ð¯i thoÕi v¾i ÐÕi Lý Vß½ng Nhßþc Vû",num=1}, {id="Ðã th¡p lØa toàn bµ Kh±ng Minh Ðång",num=24} }
--MisDescEnd
