...
x210211_g_ContinueInfo="  LØa ğã phóng ği chßa?"		--Î´Íê³ÉÈÎÎñµÄnpc¶Ô»°
x210211_g_MissionComplete="#{event_dali_0015}"					--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
x210211_g_ItemBonus={{id=10111000,num=1}}
x210211_g_SignPost = {x = 173, z = 147, tip = "Tôn Bát Gia"}
x210211_g_MoneyBonus=72
x210211_g_SignPost_1 = {x = 82, z = 220, tip = "Ği¬m ğ¯t Hoä pháo"}
