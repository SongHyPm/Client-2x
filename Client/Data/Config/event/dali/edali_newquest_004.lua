...
x210257_g_SignPost = {x = 238, z = 172, tip = "Ho鄋g C鬾g 姓o"}
x210257_g_MoneyBonus=30
x210257_g_ExpBonus=150
x210257_g_ItemBonus={{id=10110000,num=1}}
x210257_g_RadioItemBonus={}
x210257_g_DemandTrueKill ={{name="Cao S絥 B誧h Vi阯",num=8}}
x210257_g_IsMissionOkFail = 0		--变量的第0位
x210257_g_DemandKill ={{id=708,num=8}}		--变量第1位
--MisDescEnd
