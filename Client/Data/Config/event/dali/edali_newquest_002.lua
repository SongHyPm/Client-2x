...
x210255_g_SignPost = {x = 216, z = 135, tip = "B° Lß½ng"}
x210255_g_RadioItemBonus={{id=10101000 ,num=1},{id=10102000,num=1},{id=10104000,num=1},{id=10103000,num=1}}
x210255_g_Custom	= { {id="Ðã tìm th¤y Ph± Lß½ng",num=1} }
x210255_g_IsMissionOkFail = 0		--±äÁ¿µÄµÚ0Î»
--MisDescEnd
