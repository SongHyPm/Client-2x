...
x808105_g_Name 					= "Châu Vô Uý"
x808105_g_MissionKind			= 13
x808105_g_MissionLevel		= 10
x808105_g_IfMissionElite	= 0
x808105_g_IsMissionOkFail	= 0		--ÈÎÎñ²ÎÊýµÄµÚ0Î»
x808105_g_MissionName			= "Vînh h¢ng Thánh  Höa"
...
x808105_g_Custom	= { {id="Ðã giao Ðu¯c cho Tô Châu Thánh Höa Ðàn",num=1} }
--MisDescEnd
