...
x600036_g_ContinueInfo = "    Nhi®m vø cüa các hÕ vçn chßa hoàn thành à?"						--Î´Íê³ÉÈÎÎñµÄnpc¶Ô»°
x600036_g_SubmitInfo = "    Sñ tình tiªn tri¬n nhß thª nào r°i?"								--Íê³ÉÎ´Ìá½»Ê±µÄnpc¶Ô»°
x600036_g_MissionComplete = "    R¤t t¯t r¤t t¯t, tiªn ğµ xây dñng lÕi tång nhanh r°i. "			--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
x600036_g_Parameter_Item_IDRandom = { { id = 4, num = 1 } }
x600036_g_StrForePart = 2
x600036_g_FormatList = {
"",
"    Ğªn %1n mßşn %2i.#r#{BHRW_091224_1}",					-- 1
"    L¤y %2i giao cho ğÕi t±ng quän bang hµi.#r#{BHRW_091224_1}",			-- 2
"    Ğªn %1n mßşn %2i.#r#{BHRW_091224_1}",					-- 3
"    Ğªn %1n mßşn %2i.#r#{BHRW_091224_1}",					-- 4
"    %3n ğã cß¾p %2i, c¥n các hÕ ği ğoÕt lÕi.#r#{BHRW_091224_1}",		-- 5
"    L¤y %2i giao cho ğÕi t±ng quän bang hµi.#r#{BHRW_091224_1}",			-- 6
}
