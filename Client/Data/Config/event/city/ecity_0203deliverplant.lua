...
x600010_g_MissionInfo = "    Hôm nay ta mu¯n có %s, tìm lÕi ğây giúp ta!"			--ÈÎÎñÃèÊö
x600010_g_MissionTarget = "    L¤y %i t£ng cho %n.#r#{BHRW_091224_1}"			--ÈÎÎñÄ¿±ê
x600010_g_ContinueInfo = "    Nhi®m vø cüa các hÕ vçn chßa hoàn thành à?"					--Î´Íê³ÉÈÎÎñµÄnpc¶Ô»°
x600010_g_SubmitInfo = "    Sñ tình tiªn tri¬n nhß thª nào r°i?"							--Íê³ÉÎ´Ìá½»Ê±µÄnpc¶Ô»°
x600010_g_MissionComplete = "    Làm t¯t l¡m, r¤t t¯t r¤t t¯t. "					--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
