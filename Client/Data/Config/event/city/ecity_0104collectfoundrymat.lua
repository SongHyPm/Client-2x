...
x600006_g_IsMissionOkFail = 0							-- ÈÎÎñÍê³É±ê¼Ç
x600006_g_MissionName = "Nhi®m vø công trình"
x600006_g_MissionInfo = ""													--ÈÎÎñÃèÊö
x600006_g_MissionTarget = "    T× %n ğánh tan %s mµt %i.#r#{BHRW_091224_1}"			--ÈÎÎñÄ¿±ê
x600006_g_ContinueInfo = "    Nhi®m vø cüa các hÕ vçn chßa hoàn thành à?"						--Î´Íê³ÉÈÎÎñµÄnpc¶Ô»°
x600006_g_SubmitInfo = "    Sñ tình tiªn tri¬n nhß thª nào r°i?"								--Íê³ÉÎ´Ìá½»Ê±µÄnpc¶Ô»°
x600006_g_MissionComplete = "    Làm t¯t l¡m, r¤t t¯t r¤t t¯t. "						--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
