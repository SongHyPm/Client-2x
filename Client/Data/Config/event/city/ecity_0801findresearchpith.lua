...
x600041_g_ContinueInfo			= "    Nhi®m vø cüa các hÕ vçn chßa hoàn thành à?"							--Î´Íê³ÉÈÎÎñµÄnpc¶Ô»°
x600041_g_SubmitInfo			= "    Sñ tình tiªn tri¬n nhß thª nào r°i?"								--Íê³ÉÎ´Ìá½»Ê±µÄnpc¶Ô»°
x600041_g_MissionComplete		= "    R¤t t¯t r¤t t¯t, tiªn ğµ nghiên cÑu tång nhanh không ít. "				--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
x600041_g_Parameter_Item_IDRandom = { { id = 4, num = 1 } }
x600041_g_StrForePart			= 2
x600041_g_FormatList			= {
"",
"    Thß m§t viªt: Trình lên thü lînh quı bang b¢ng hæu, t¤t cä %2i ğßa ğªn ğã nh§n, ngân lßşng s¨ dâng lên theo. Ta ch¶ giá ngñ ğªn l¤y. B¢ng hæu: %1n kh¤u ğ¥u.#r#{BHRW_091224_1}",	--1 ÊÕÌõÊéĞÅ
"    Tìm %3n ğoÕt lÕi %2i.#r#{BHRW_091224_1}",																				--2 Ñ°ÕÒÑĞ¾¿ÒªÊõ
"    L¤y %2i giao cho ğÕi t±ng quän bang hµi.#r#{BHRW_091224_1}"																			--3 ËÍ»¹
}
