...
x600005_g_MissionInfo = "    Hôm nay ta mu¯n có %s, tìm lÕi ğây giúp ta!"			--ÈÎÎñÃèÊö
x600005_g_MissionTarget = "    L¤y %i t£ng cho %n.#r#{BHRW_091224_1}"			--ÈÎÎñÄ¿±ê
...
x600005_g_ItemOffset = 18												-- Suppose to 18, ±íÀïµÚ¼¸¸öÎïÆ·ÁĞµÄÆ«ÒÆÁ¿
x600005_g_NPCOffset = 7													-- Suppose to 7, ±íÀïµÚ¼¸ÁĞ NPC µÄÆ«ÒÆÁ¿
x600005_g_NPCOffsetEx = 245													-- Suppose to 7, ±íÀïµÚ¼¸ÁĞ NPC µÄÆ«ÒÆÁ¿
