...
x212113_g_MissionName="Ð¥u sö tµi ác"
x212113_g_MissionInfo="#{Mis_K_Meiling_1000183}"
x212113_g_MissionTarget="    Nguy®t Lý · Mai Lînh #{_INFOAIM192,70,33,Nguy®t Lý} yêu c¥u ngß½i giªt chªt Nghiêm BÕch H±. C¦n th§n, chï c¥n Nguy®t Lý b¡t ð¥u cúng tª, #RNghiêm BÕch H±#W s¨ xu¤t hi®n ngay."		
x212113_g_ContinueInfo="  Ngß½i ðã giªt chªt Nghiêm BÕch H± chßa?"
x212113_g_MissionComplete="  Ða tÕ ngß½i, ða tÕ. Ha ha... ta không sao. CÑ m²i l¥n cúng tª lÕi t±n hao ít chân khí.."		
x212113_g_MoneyBonus=51700
x212113_g_exp=37000
x212113_g_szMonsterName = "Nghiêm BÕch H±"
x212113_g_MonsterID = 525
x212113_g_Custom	= { {id="Ðã giªt chªt Nghiêm BÕch H±",num=1} }
