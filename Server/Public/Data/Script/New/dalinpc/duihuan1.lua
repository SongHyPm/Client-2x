...
x990002_g_StoneList={
-- 飞蝗石（普）
{n=1,id=10433310,num=10,str="飞蝗石（普）"},
-- 飞蝗石（中）
{n=2,id=10433311,num=10,str="飞蝗石（中）"},
-- 梅花镖（普）
{n=3,id=10433316,num=10,str="梅花镖（普）"},
-- 梅花镖（中）
...
function x990002_UpdateEventList( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		--AddNumText( sceneId, x990002_g_ScriptId, "#gFF3E96兑换暗器", 3, 100 )
		--AddNumText( sceneId, x990002_g_ScriptId, "#gFF3E96兑换武魂", 3, 400 )
		AddNumText( sceneId, x990002_g_ScriptId, "#gFF3E96武魂技能领悟", 3, 300 )
		AddNumText( sceneId, x990002_g_ScriptId, "离开……", 13, 0 )
...
function x990002_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if nNumText == 100 or nNumText == 200 or nNumText == 300 or nNumText == 400 or nNumText == 500 or nNumText == 600 or nNumText == 700 or nNumText == 710 or nNumText == 720 or nNumText == 730 or nNumText == 740 or nNumText == 750 or nNumText == 760 then
		BeginEvent(sceneId)
			...
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换飞蝗石（中）", 1, nNumText+10)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换飞蝗石（高）", 1, nNumText+20)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换梅花镖（中）", 1, nNumText+30)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换梅花镖（高）", 1, nNumText+40)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换冰魄神针（中）", 1, nNumText+50)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换冰魄神针（高）", 1, nNumText+60)
			end
			if nNumText == 200 then
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96领取飞蝗石状态（昏睡）", 1, nNumText+10)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96领取梅花镖状态（失明）", 1, nNumText+11)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96领取冰魄神针状态（恐惧）", 1, nNumText+12)
			end
			if nNumText == 300 then
   		--AddNumText( sceneId, x990002_g_ScriptId, "#gFF3E96领取暗器状态", 1, 200)
			--AddNumText( sceneId, x990002_g_ScriptId, "#gFF3E96领取武魂状态", 1, 500)
			AddNumText( sceneId, x990002_g_ScriptId, "#gFF3E96领取武魂技能", 1, 600)
			end
			if nNumText == 400 then
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换御窑盘[毒]", 1, nNumText+10)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换御窑盘[火]", 1, nNumText+11)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换御窑盘[冰]", 1, nNumText+12)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换御窑盘[玄]", 1, nNumText+13)
			--AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换《神话》守护", 1, nNumText+14)
			--AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换《神话》之恋", 1, nNumText+15)
			--AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换《神话》束带", 1, nNumText+16)
			--AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换《神话》之泪", 1, nNumText+17)
			--AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换《神话》虎符", 1, nNumText+18)
			--AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96兑换《神话》流云镯", 1, nNumText+19)
			end
			if nNumText == 500 then
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96领取御窑盘[毒]技能", 1, nNumText+10)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96领取御窑盘[火]技能", 1, nNumText+11)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96领取御窑盘[冰]技能", 1, nNumText+12)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96领取御窑盘[玄]技能", 1, nNumText+13)

			end				
			if nNumText == 600 then
   			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96学习剧毒瘟疫[毒]技能", 1, nNumText+10)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96学习天火燎原[火]技能", 1, nNumText+11)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96学习冰封万里[冰]技能", 1, nNumText+12)
			AddNumText(sceneId, x990002_g_ScriptId, "#gFF3E96学习狂雷天降[玄]技能", 1, nNumText+13)
			end
			if nNumText == 700 then
   			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·人界神兵", 1, 710)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·鬼界神兵", 1, 720)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·妖界神兵", 1, 730)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·仙界神兵", 1, 740)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·神界神兵", 1, 750)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·魔界神兵", 1, 760)
			end	
			if nNumText == 710 then      -- 人界 
   			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·惊邪【土】", 1, nNumText+1)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·太虚【土】", 1, nNumText+2)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·神农【土】", 1, nNumText+3)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·执念【土】", 1, nNumText+4)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·盘古【土】", 1, nNumText+5)
			end	
			if nNumText == 720 then      -- 鬼界 
      		AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·焰影【火】", 1, nNumText+1)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·裂天【火】", 1, nNumText+2)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·疚疯【火】", 1, nNumText+3)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·阴阳【火】", 1, nNumText+4)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·虚无【火】", 1, nNumText+5)
			end	
			if nNumText == 730 then      -- 仙界 
      		AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·玄天【圣】", 1, nNumText+1)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·混元【圣】", 1, nNumText+2)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·紫电【圣】", 1, nNumText+3)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·乾坤【圣】", 1, nNumText+4)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·太极【圣】", 1, nNumText+5)
			end	
			if nNumText == 740 then      -- 妖界 
      		AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·噬魂【风】", 1, nNumText+1)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·凤凰【风】", 1, nNumText+2)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·帝恨【风】", 1, nNumText+3)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·缚神【风】", 1, nNumText+4)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·俱灭【风】", 1, nNumText+5)
			end	
			if nNumText == 750 then      -- 神界 
      		AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·天晶【水】", 1, nNumText+1)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·天诛【水】", 1, nNumText+2)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·日月【水】", 1, nNumText+3)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·神舞【水】", 1, nNumText+4)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·紫绶【水】", 1, nNumText+5)
			end	
			if nNumText == 760 then      -- 魔界 
      		AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·虎魄【雷】", 1, nNumText+1)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·无妄【雷】", 1, nNumText+2)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·破地【雷】", 1, nNumText+3)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·悲怒【雷】", 1, nNumText+4)
			AddNumText( sceneId, x990002_g_ScriptId, "炼化神兵·虚无【雷】", 1, nNumText+5)
			end																			
			AddNumText( sceneId, x990002_g_ScriptId, "离开……", 0, 0 )
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId)
		return
	end
	...
	if nNumText > 100 and nNumText < 800  then
		BeginEvent(sceneId)
			...
			if nNumText == 120 then    -- 兑换飞蝗石
				nLevel = 2
			end
			if nNumText == 130 then    -- 兑换梅花镖
				nLevel = 3
			end	
			if nNumText == 140 then    -- 兑换梅花镖
				nLevel = 4
			end						
			if nNumText == 150 then    -- 兑换冰魄神针
				nLevel = 5
			end	
			if nNumText == 160 then    -- 兑换冰魄神针
				nLevel = 6
			end	
			...
			local szStr = "  要获得这些装备，你需要给我“" .. x990002_g_StoneList[nLevel].str
										.. "”“".. tostring(x990002_g_StoneList[nLevel].num) .. "”个  #r  #G注意看装备适合什么门派，不要换错了哦#W"
...
function x990002_OnMissionSubmit( sceneId, selfId, targetId, missionScriptId, selectRadioId )
	...
	if bDelOk < 1  then
		...
		elseif randMessage == 2 then
			...
			message = format("#W#{WLS_00}#Y%d#cffffcc颗#W#{_INFOMSG%s}#cffffcc由衷的赞道：“#W#{_INFOUSR%s}#{WLS_01}#{_INFOMSG%s}#{WLS_02}", x990002_g_StoneList[nLevel].num, szTransferStone, LuaFnGetName(sceneId, selfId), szTransferEquip);
		end
