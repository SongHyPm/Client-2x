...
function x402276_CheckCanEnter( sceneId, selfId, targetId )
	...
	--¶ÓÎé´ïµ½ÈËÊýÒªÇó?
		...
		if teamSize < x402276_g_LimitMembers then
			return 0, "T¯i Thi¬u " .. x402276_g_LimitMembers .. " ngß¶i m¾i có thª tham gia sñ ki®n Phiêu Mi­n phong";				
		end
	...
	if nHumanNum > 0 then
		...
		msg = msg .. Humanlist[nHumanNum-1] .. " ðã tham gia Khiêu Chiªn quá 1 l¥n."
		return 0, msg
