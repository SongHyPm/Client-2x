...
function x402305_ChangePiaoMiaoTitle(sceneId, selfId, targetId,titleLv)
	...
	if (costRet ~= 1) then
		x402305_NotifyFailBox(sceneId, selfId, targetId, "Kh¤u tr× v§t ph¦m th¤t bÕi!")
		return
	end
...
function x402305_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if (nNum == 21) then
		BeginEvent(sceneId)
			...
			AddNumText( sceneId, x402305_g_scriptId, "TÕi hÕ mu¯n ð±i", 6, 1 )
			AddNumText( sceneId, x402305_g_scriptId, "Không c¥n ð±i", 0, 100 )
		EndEvent(sceneId)
	...
	if (nNum == 22) then
		BeginEvent(sceneId)
			...
			AddNumText( sceneId, x402305_g_scriptId, "TÕi hÕ mu¯n ð±i", 6, 2 )
			AddNumText( sceneId, x402305_g_scriptId, "Không c¥n ð±i", 0, 100 )
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId,x402305_g_scriptId,0)
	end
	...
	if (nNum == 23) then
		BeginEvent(sceneId)
			...
			AddNumText( sceneId, x402305_g_scriptId, "TÕi hÕ mu¯n ð±i", 6, 3 )
			AddNumText( sceneId, x402305_g_scriptId, "Không c¥n ð±i", 0, 100 )
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId,x402305_g_scriptId,0)
	end
	...
	if (nNum == 24) then
		BeginEvent(sceneId)
			...
			AddNumText( sceneId, x402305_g_scriptId, "TÕi hÕ mu¯n ð±i", 6, 4 )
			AddNumText( sceneId, x402305_g_scriptId, "Không c¥n ð±i", 0, 100 )
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId,x402305_g_scriptId,0)
	end
...
function x402305_OnEnumerate( sceneId, selfId, targetId )
	AddNumText( sceneId, x402305_g_scriptId, "Ð±i danh hi®u Phiêu Mi¬u Phong", 3, 10 )	
