...
--¸±±¾Ãû³Æ
x401020_g_CopySceneName="ThuÖ lao"

--ÈÎÎñºÅ
x401020_g_MissionId = 1055

--Ä¿±êNPC
x401020_g_Name = "ThuÖ lao"
...
--ÈÎÎñÎÄ±¾ÃèÊö
x401020_g_MissionName="ThuÖ lao"
x401020_g_MissionInfo="Giªt hªt toàn bµ quái v§t, 1 con cûng không tha!"  --ÈÎÎñÃèÊö
x401020_g_MissionTarget="Giªt hªt toàn bµ quái v§t"	--Møc tiêu nhi®m vø
x401020_g_ContinueInfo="Các hÕ phäi tiªp tøc c¯ g¡ng nhé!"	--Î´Hoàn t¤t nhi®m vøtoÕ ğµ npc¶Ô»°
x401020_g_MissionComplete="Cám ½n, chúng tôi cu¯i cùng cûng ğã dám ra khöi cØa r°i"	--Hoàn t¤t nhi®m vønpcËµ»°toÕ ğµ »°
...
x401020_g_Param_huan		=0	--0ºÅ: ÒÑ¾­Íê³ÉtoÕ ğµ »·Êı,TÕi ½ÓÊÕÈÎÎñÊ±ºò¸³Öµ
x401020_g_Param_ok			=1	--1ºÅ: µ±Ç°ÈÎÎñĞúng·ñÍê³É(0Î´Íê³É£»1Íê³É)
x401020_g_Param_sceneid		=2	--2ºÅ: µ±Ç°¸±±¾ÈÎÎñtoÕ ğµ ³¡¾°ºÅ
x401020_g_Param_teamid		=3	--3ºÅ: ½Ó¸±±¾ÈÎÎñÊ±ºòtoÕ ğµ ¶ÓÎéºÅ
x401020_g_Param_killcount	=4	--4ºÅ: É±ËÀÈÎÎñ¹ÖtoÕ ğµ ÊıÁ¿
x401020_g_Param_time		=5	--5ºÅ: Íê³É¸±±¾ËùÓÃÊ±¼ä(µ¥Î»:  giây)
--6ºÅ: Î´ÓÃ
--7ºÅ: Î´ÓÃ

x401020_g_CopySceneType=FUBEN_EXAMPLE	--¸±±¾ÀàĞÍ,¶¨ÒåTÕi ScriptGlobal.luaÀïÃæ
x401020_g_LimitMembers=3			--¿ÉÒÔ½ø¸±±¾toÕ ğµ ×îĞ¡¶ÓÎéÈËÊı
x401020_g_TickTime=5				--»Øµ÷½Å±¾toÕ ğµ Ê±ÖÓÊ±¼ä(µ¥Î»:  giây/´Î)
x401020_g_LimitTotalHoldTime=360	--¸±±¾¿ÉÒÔ´æ»îtoÕ ğµ Ê±¼ä(µ¥Î»: ´ÎÊı),Èç¹û´ËÊ±¼äµ½ÁË,ÔòÈÎÎñ½«»áth¤t bÕi
x401020_g_LimitTimeSuccess=500		--¸±±¾Ê±¼äÏŞÖÆ(µ¥Î»: ´ÎÊı),Èç¹û´ËÊ±¼äµ½ÁË,ÈÎÎñÍê³É
x401020_g_CloseTick=6				--¸±±¾¹Ø±ÕÇ°µ¹¼ÆÊ±(µ¥Î»: ´ÎÊı)
x401020_g_NoUserTime=300			--¸±±¾ÖĞÃ»ÓĞÈËºó¿ÉÒÔ¼ÌĞø±£´ætoÕ ğµ Ê±¼ä(µ¥Î»:  giây)
x401020_g_DeadTrans=1				--ËÀÍö×ªÒÆÄ£Ê½,0: ËÀÍöºó»¹¿ÉÒÔ¼ÌĞøTÕi ¸±±¾,1: ËÀÍöºó±»Ç¿ÖÆÒÆ³ö¸±±¾
x401020_g_Fuben_X=64				--½øÈë¸±±¾toÕ ğµ Î»ÖÃX
x401020_g_Fuben_Z=64				--½øÈë¸±±¾toÕ ğµ Î»ÖÃZ
x401020_g_Back_X=234				--Ô´³¡¾°Î»ÖÃX
x401020_g_Back_Z=69					--Ô´³¡¾°Î»ÖÃZ
x401020_g_NeedMonsterGroupID=1		--C¥n É±ËÀtoÕ ğµ BosstoÕ ğµ GroupID
x401020_g_TotalNeedKillBoss=10		--C¥n É±ËÀBossÊıÁ¿

--**********************************
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x401020_OnDefaultEvent( sceneId, selfId, targetId )
	if( IsHaveMission(sceneId,selfId,x401020_g_MissionId) > 0)  then	--Èç¹ûÍæ¼ÒÒÑ¾­½ÓÁËCái này ÈÎÎñ
    ...
    elseif x401020_CheckAccept(sceneId,selfId) > 0 then		--Ã»ÓĞÈÎÎñ,Thöa mãnÈÎÎñ½ÓÊÕÌõ¼ş
...
function x401020_CheckTeamLeader( sceneId, selfId )
	if	GetTeamId( sceneId, selfId)<0	then	--ÅĞ¶ÏĞúng·ñÓĞ¶ÓÎé
		BeginEvent(sceneId)
...
function x401020_CheckAccept( sceneId, selfId )
	...
	for	i=0,nearteammembercount-1 do
		...
		if GetMissionCount( sceneId, mems[i]) >= 20 then	--¶ÓÓÑÉíÉÏÈÎÎñÊıÁ¿Ğúng·ñ´ïµ½ÉÏÏŞ20cái
			BeginEvent(sceneId)
...
function x401020_OnAccept( sceneId, selfId )
	...
	if( IsHaveMission(sceneId,selfId,x401020_g_MissionId) > 0)  then	--ÒÑ¾­ÓĞÈÎÎñtoÕ ğµ 
		misIndex = GetMissionIndexByID(sceneId,selfId,x401020_g_MissionId)
		...
		for	i=0,nearteammembercount-1 do
			...
			--½«ÈÎÎñtoÕ ğµ µÚ0ºÅÊı¾İÉèÖÃÎªÒÑ¾­Íê³ÉtoÕ ğµ 
...
function x401020_MakeCopyScene( sceneId, selfId, nearmembercount )
	...
	LuaFnSetCopySceneData_Param(sceneId, 0, x401020_g_CopySceneType);--ÉèÖÃ¸±±¾Êı¾İ,ÕâÀï½«0ºÅË÷ÒıtoÕ ğµ Êı¾İÉèÖÃÎª999,ÓÃÓÚ±íÊ¾¸±±¾ºÅ999(Êı×Ö×Ô¶¨Òå)
...
function x401020_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	...
	if x401020_CheckSubmit( sceneId, selfId, selectRadioId )>0 then		--ÒÑ¾­Hoàn t¤t nhi®m vøÁË
	
		local	iHuan=GetMissionData(sceneId,selfId,MD_SHUILAO_HUAN)	--È¡ ği¬m×Ü¹²×ö¹ıtoÕ ğµ »·Êı
		iHuan=iHuan+1
		--begin modified by zhangguoxin 090207
		local iDayCount=GetMissionData(sceneId,selfId,MD_SHUILAO_DAYCOUNT)
		local iTime = mod(iDayCount,100000)
		--local iDayTime = floor(iTime/100)	--ÉÏmµt ´Î½»ÈÎÎñtoÕ ğµ Ê±¼ä(ÌìÊı)
		local iDayTime = iTime							--ÉÏmµt ´Î½»ÈÎÎñtoÕ ğµ Ê±¼ä(ÌìÊı)
		--local iHourTime = mod(iTime,100)	--ÉÏmµt ´Î½»ÈÎÎñtoÕ ğµ Ê±¼ä(Ğ¡Ê±)
...
function x401020_OnKillObject( sceneId, selfId, objdataId ,objId )
	...
	if GroupID ~= x401020_g_NeedMonsterGroupID then
		return --²»ĞúngËùC¥n toÕ ğµ Boss
	end
	
	killedbossnumber = LuaFnGetCopySceneData_Param(sceneId, 7) ;--É±ËÀBosstoÕ ğµ ÊıÁ¿
	...
	if killedbossnumber<x401020_g_TotalNeedKillBoss then
		...
		BeginEvent(sceneId)
			strText = format("Ğã giªt trùm %d/%d", killedbossnumber, x401020_g_TotalNeedKillBoss )
			AddText(sceneId,strText);
		EndEvent(sceneId)
		...
		for i=0,num-1 do
			...
			misIndex = GetMissionIndexByID(sceneId,humanObjId,x401020_g_MissionId) --È¡ ği¬mÈÎÎñÊı¾İË÷ÒıÖµ
			local killedcount = GetMissionParam( sceneId, humanObjId, misIndex, x401020_g_Param_killcount) --È¡ ği¬mÒÑ¾­É±ÁËtoÕ ğµ ¹ÖÎïÊı
...
function x401020_OnHumanDie( sceneId, selfId, killerId )
	if x401020_g_DeadTrans==1 then --ËÀÍöºóC¥n ±»Ç¿ÖÆÌß³ö³¡¾°
	
		misIndex = GetMissionIndexByID(sceneId,selfId,x401020_g_MissionId)--È¡ ği¬mÈÎÎñÊı¾İË÷ÒıÖµ
...
function x401020_OnCopySceneTimer( sceneId, nowTime )
	...
	elseif TickCount == x401020_g_LimitTimeSuccess then
		...
		for	i=0,membercount-1 do
			...
			misIndex = GetMissionIndexByID(sceneId,mems[i],x401020_g_MissionId)--È¡ ği¬mÈÎÎñÊı¾İË÷ÒıÖµ
			--½«ÈÎÎñtoÕ ğµ µÚ1ºÅÊı¾İÉèÖÃÎª1,±íÊ¾Íê³ÉtoÕ ğµ ÈÎÎñ
	...
	elseif TickCount == x401020_g_LimitTotalHoldTime then --¸±±¾×ÜÊ±¼äÏŞÖÆµ½ÁË
		...
		for	i=0,membercount-1 do
			mems[i] = LuaFnGetCopyScene_HumanObjId(sceneId,i)
			DelMission( sceneId, mems[i], x401020_g_MissionId );--ÈÎÎñth¤t bÕi,É¾³ıÖ®
		...
		for	i=0,membercount-1 do
			...
			if IsHaveMission(sceneId,mems[i],x401020_g_MissionId) > 0 then
				oldteamid = LuaFnGetCopySceneData_Param(sceneId, 6) ; --È¡ ği¬m±£´ætoÕ ğµ ¶ÓÎéºÅ
