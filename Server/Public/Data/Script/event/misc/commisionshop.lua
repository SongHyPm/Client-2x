...
x800116_g_ScriptId = 800116  -- ´úÂëÖÐÒ²Ê¹ÓÃCái này ±àºÅÁË.ÑÏ½ûÐÞ¸Ä

-- ¼ÄÊÛÉÌµêUI 19850424

-- ¼ÄÊÛÉÌµêÐÅÏ¢
x800116_g_CShopInfo = {
	-- 0 ºÅÉÌµê,ÕâÑùtoÕ ðµ »°×îºÃ²»Òª³öÏÖÁ½cái Server mµt cái ShopID toÕ ðµ ÏÖÏó,·ñÔmµt ¹Òª¸ÄCái này Êý¾Ý½á¹¹
	[0] = {
		name = "#G LÕc Dß½ng (160,181) #RÐinh Ðinh",
		type = {
			-- Ôª±¦
			[0] = {
				name = "Ðïnh vàng",
	...
	-- 1 ºÅÉÌµê,ÕâÑùtoÕ ðµ »°×îºÃ²»Òª³öÏÖÁ½cái Server mµt cái ShopID toÕ ðµ ÏÖÏó,·ñÔmµt ¹Òª¸ÄCái này Êý¾Ý½á¹¹
	[1] = {
		name = "#G LÕc Dß½ng (158, 181) #RÐông Ðông",
		type = {
			-- Ôª±¦
			[0] = {
				name = "Ðïnh vàng",
