...
--ÈÎÎñÎÄ±¾ÃèÊö
x808033_g_MissionName			= "Ğánh lén môn phái"
--ÈÎÎñÃèÊö
x808033_g_MissionInfo			= "  "
--Møc tiêu nhi®m vø
x808033_g_MissionTarget		= "  Giªt hªt quái v§t li«n có th¬ hoàn t¤t nhi®m vø"
...
x808033_g_Param_IsMissionOkFail	= 0						--0ºÅ: µ±Ç°ÈÎÎñĞúng·ñÍê³É(0Î´Íê³É£»1Íê³É)
x808033_g_Param_killmonstercount	= 1					--1ºÅ: É±ËÀÈÎÎñĞ¡¹ÖtoÕ ğµ ÊıÁ¿
x808033_g_Param_killbosscount	= 2							--2ºÅ: É±ËÀÈÎÎñboss¹ÖtoÕ ğµ ÊıÁ¿
x808033_g_Param_sceneid		= 3									--3ºÅ: µ±Ç°¸±±¾ÈÎÎñtoÕ ğµ ³¡¾°ºÅ
x808033_g_Param_teamid		= 4									--4ºÅ: ½Ó¸±±¾ÈÎÎñÊ±ºòtoÕ ğµ ¶ÓÎéºÅ
x808033_g_Param_time			= 5									--5ºÅ: Íê³É¸±±¾ËùÓÃÊ±¼ä(µ¥Î»:  giây)
																							--6ºÅ: ¾ßÌå¸±±¾ÊÂ¼ş½Å±¾Õ¼ÓÃ
																							--7ºÅ: ¾ßÌå¸±±¾ÊÂ¼ş½Å±¾Õ¼ÓÃ
--MisDescEnd
--************************************************************************

x808033_g_CopySceneType			= FUBEN_WUDANG1	--¸±±¾ÀàĞÍ,¶¨ÒåTÕi ScriptGlobal.luaÀïÃæ
x808033_g_LimitMembers			= 1		--¿ÉÒÔ½ø¸±±¾toÕ ğµ ×îĞ¡¶ÓÎéÈËÊı
x808033_g_TickTime					= 5		--»Øµ÷½Å±¾toÕ ğµ Ê±ÖÓÊ±¼ä(µ¥Î»:  giây/´Î)
x808033_g_LimitTotalHoldTime= 360	--¸±±¾¿ÉÒÔ´æ»îtoÕ ğµ Ê±¼ä(µ¥Î»: ´ÎÊı),Èç¹û´ËÊ±¼äµ½ÁË,ÔòÈÎÎñ½«»áth¤t bÕi
x808033_g_LimitTimeSuccess	= 500	--¸±±¾Ê±¼äÏŞÖÆ(µ¥Î»: ´ÎÊı),Èç¹û´ËÊ±¼äµ½ÁË,ÈÎÎñÍê³É
x808033_g_CloseTick					= 6		--¸±±¾¹Ø±ÕÇ°µ¹¼ÆÊ±(µ¥Î»: ´ÎÊı)
x808033_g_NoUserTime				= 300	--¸±±¾ÖĞÃ»ÓĞÈËºó¿ÉÒÔ¼ÌĞø±£´ætoÕ ğµ Ê±¼ä(µ¥Î»:  giây)
x808033_g_Fuben_X						= 93	--½øÈë¸±±¾toÕ ğµ Î»ÖÃX
x808033_g_Fuben_Z						= 182	--½øÈë¸±±¾toÕ ğµ Î»ÖÃZ
x808033_g_Back_X						= 93	--Ô´³¡¾°Î»ÖÃX
x808033_g_Back_Z						= 182	--Ô´³¡¾°Î»ÖÃZ
x808033_g_Totalkillmonstercount	= 30	--C¥n É±ËÀmonsterÊıÁ¿
x808033_g_Totalkillbosscount	= 1	--C¥n É±ËÀBossÊıÁ¿

--¸±±¾Êı¾İË÷Òı¶ÔÕÕ
x808033_g_keySD					= {}
x808033_g_keySD["typ"]	= 0		--ÉèÖÃ¸±±¾ÀàĞÍ
x808033_g_keySD["spt"]	= 1		--ÉèÖÃ¸±±¾³¡¾°ÊÂ¼ş½Å±¾ºÅ
x808033_g_keySD["tim"]	= 2		--ÉèÖÃ¶¨Ê±Æ÷µ÷ÓÃ´ÎÊı
x808033_g_keySD["scn"]	= 3		--ÉèÖÃ¸±±¾Èë¿Ú³¡¾°ºÅ, ³õÊ¼»¯
x808033_g_keySD["cls"]	= 4		--ÉèÖÃ¸±±¾¹Ø±Õ±êÖ¾, 0¿ª·Å,1¹Ø±Õ
x808033_g_keySD["dwn"]	= 5		--ÉèÖÃÀë¿ªµ¹¼ÆÊ±´ÎÊı
x808033_g_keySD["tem"]	= 6		--±£´æ¶ÓÎéºÅ
x808033_g_keySD["x"]	= 7			--ÈËÎïTÕi Èë¿Ú³¡¾°ÖĞtoÕ ğµ xÎ»ÖÃ
x808033_g_keySD["z"]	= 8			--ÈËÎïTÕi Èë¿Ú³¡¾°ÖĞtoÕ ğµ zÎ»ÖÃ
x808033_g_keySD["killedmonsternum"]	= 9		--É±ËÀà¶ÂŞtoÕ ğµ ÊıÁ¿
x808033_g_keySD["killedbossnum"]	= 10		--É±ËÀBosstoÕ ğµ ÊıÁ¿
x808033_g_keySD["mp"]	= 11		--¼ÇÂ¼µ±Ç°¸±±¾toÕ ğµ  ÃÅÅÉ

--½ÓÈ¡ÈÎÎñtoÕ ğµ ×îµÍµÈc¤p
x808033_g_minLevel			= 20
--C¥n ÅäÖÃĞ¡¹ÖÎï
x808033_g_typMonster		= 749	--Ë®¹íÌ½×Ó
--ÃÅÅÉid
...
function x808033_OnEnumerate( sceneId, selfId, targetId )
	...
	if(MenPaiID ~= x808033_g_MenPaiID) then
		x808033_NotifyTip( sceneId, selfId, "Ta t¾i Võ Ğang ğ¬ höi tµi, ngß½i không phäi là ğ® tØ cüa Võ Ğang, mau tránh mau ra" )
		return
	end

	local	lev	= GetLevel( sceneId, selfId )
	if lev < x808033_g_minLevel then
	  x808033_NotifyTip( sceneId, selfId, "ĞÆng c¤p cüa ngß½i quá th¤p, c½ bän không l÷t vào m¡t ta. Ğşi sau khi ğÕt c¤p 20, hãy t¾i tìm ta" )
		return
	end

	if LuaFnHasTeam( sceneId, selfId ) == 0 then
		x808033_NotifyTip( sceneId, selfId, "Ngß½i mu¯n t¾i thØ ta, nhßng c½ bän ta không mu¯n ğµng thü v¾i ngß½i" )
		return
	end
	--PrintNum(3)

	if GetTeamSize( sceneId, selfId ) < x808033_g_LimitMembers then
	  x808033_NotifyTip( sceneId, selfId, "Mu¯n thØ thách ta chí ít cûng phäi t¾i "..x808033_g_LimitMembers.." ngß¶i. Có tí ngß¶i thª này, quá coi thß¶ng ta" )
	  return
	end
	--PrintNum(4)

	if LuaFnIsTeamLeader( sceneId, selfId ) == 0 then
		x808033_NotifyTip( sceneId, selfId, "Mu¯n thØ thách ta? G÷i nhóm trß·ng cüa các ngß½i ra ğây" )
		return
	end
	--PrintNum(5)
	...
	if nearteammembercount ~= LuaFnGetTeamSize( sceneId, selfId ) then
		x808033_NotifyTip( sceneId, selfId, "Trong ğµi ngû cüa các hÕ có thành viên không · phø c§n, xin hãy t§p trung r°i ğªn tìm ta ğßa vào hoÕt ğµng." )
		return
	end
	...
	BeginEvent( sceneId )
		...
		AddNumText( sceneId, x808033_g_ScriptId, "L¨ nào ta lÕi sş ngß½i.." ,10 ,0 )
  EndEvent( sceneId )
	...
	if IsHaveMission( sceneId, selfId, x808033_g_MissionId ) > 0 then
		...
		if copysceneid >= 0 and teamid == saveteamid then
			...
			if IsCanEnterCopyScene( copysceneid, GetHumanGUID( sceneId, selfId ) ) == 1 then
				...
				x808033_NotifyTip( sceneId, selfId, "Nhi®m vø th¤t bÕi, hãy bö ği và nh§n lÕi" )
...
function x808033_OnAbandon( sceneId, selfId )
	...
	local oldsceneId = LuaFnGetCopySceneData_Param( sceneId, x808033_g_keySD["scn"] )	--È¡ ği¬m¸±±¾Èë¿Ú³¡¾°ºÅ
...
--	PrintStr("  "..x..z.." ")
  ...
  LuaFnSetCopySceneData_Param(sceneId, 13, mylevel)
	...
	if bRetSceneID > 0 then
		x808033_NotifyTip( sceneId, selfId, "D¸ch chuy¬n thành công!" )
	else
		x808033_NotifyTip( sceneId, selfId, "S¯ lßşng bän sao ğã ğªn gi¾i hÕn, ğ« ngh¸ lát næa thØ lÕi!" )
...
function x808033_OnKillObject( sceneId, selfId, objdataId, objId )
	...
	local killedmonsternumber = LuaFnGetCopySceneData_Param( sceneId, x808033_g_keySD["killedmonsternum"] )			--É±ËÀmonstertoÕ ğµ ÊıÁ¿
	local killedbossnumber = LuaFnGetCopySceneData_Param( sceneId, x808033_g_keySD["killedbossnum"] )			--É±ËÀbosstoÕ ğµ ÊıÁ¿
	...
	if(MonsterName == "Lâu La")then
		...
		LuaFnSetCopySceneData_Param( sceneId, x808033_g_keySD["killedmonsternum"], killedmonsternumber )					--ÉèÖÃÉ±ËÀmonstertoÕ ğµ ÊıÁ¿
		isBoss = 0
	...
	elseif ( MonsterName == "Ác Bá" ) then
		...
		LuaFnSetCopySceneData_Param( sceneId, x808033_g_keySD["killedbossnum"], killedbossnumber )					--ÉèÖÃÉ±ËÀbosstoÕ ğµ ÊıÁ¿
		isBoss = 1
	end
	...
	if (killedmonsternumber < x808033_g_Totalkillmonstercount ) or (killedbossnumber < x808033_g_Totalkillbosscount )then
		local strText = format( "Ğã giªt chªt b÷n Lâu la: %d/%d ğã giªt chªt b÷n Ác Bá: %d/%d" , killedmonsternumber, x808033_g_Totalkillmonstercount, killedbossnumber, x808033_g_Totalkillbosscount )
		for i=0, num-1 do
			...
			if LuaFnIsObjValid( sceneId, humanObjId ) == 1 and LuaFnIsCanDoScriptLogic( sceneId, humanObjId ) == 1 then					--²»TÕi ³¡¾°toÕ ğµ ²»×ö´Ë²Ù×÷
				...
				misIndex = GetMissionIndexByID( sceneId, humanObjId, x808033_g_MissionId )					--È¡ ği¬mÈÎÎñÊı¾İË÷ÒıÖµ
				SetMissionByIndex( sceneId, humanObjId, misIndex, x808033_g_Param_killmonstercount, killedmonsternumber )	--ÉèÖÃÈÎÎñÊı¾İ
				SetMissionByIndex( sceneId, humanObjId, misIndex, x808033_g_Param_killbosscount, killedbossnumber )	--ÉèÖÃÈÎÎñÊı¾İ
			end
		end
	else
		...
		local strText = format( "Ğã giªt chªt b÷n Lâu la: %d/%d ğã giªt chªt b÷n Ác Bá: %d/%d", x808033_g_Totalkillmonstercount, x808033_g_Totalkillmonstercount, x808033_g_Totalkillbosscount, x808033_g_Totalkillbosscount)
		local strText2 = format( "Nhi®m vø hoàn thành, sau %d giây s¨ chuy¬n t¾i v¸ trí vào cØa", x808033_g_CloseTick * x808033_g_TickTime )
		...
		for i=0, num-1 do
			...
			if LuaFnIsObjValid( sceneId, humanObjId ) == 1 and LuaFnIsCanDoScriptLogic( sceneId, humanObjId ) == 1 then										--²»TÕi ³¡¾°toÕ ğµ ²»×ö´Ë²Ù×÷
				...
				SetMissionByIndex( sceneId, humanObjId, misIndex, x808033_g_Param_IsMissionOkFail, 1 )					--ÉèÖÃÈÎÎñÊı¾İ
				--Íê³É¸±±¾ËùÓÃÊ±¼ä
				SetMissionByIndex( sceneId, humanObjId, misIndex, x808033_g_Param_time, TickCount * x808033_g_TickTime )	--ÉèÖÃÈÎÎñÊı¾İ
	...
	for	i=0, numMem-1 do
		...
		if LuaFnIsCanDoScriptLogic( sceneId, member ) == 1 then			-- ´¦ÓÚ¿ÉÒÔÖ´ĞĞÂß¼­toÕ ğµ ×´Ì¬
			if IsHaveMission( sceneId, member, x808033_g_MissionId ) > 0 then
				...
				x808033_NotifyTip( sceneId, member, "Các hÕ ğã không nh§n nhi®m vø này t× trß¾c" )
			end
		end
	end
end
...
function x808033_OnPlayerEnter( sceneId, selfId )
	if IsHaveMission( sceneId, selfId, x808033_g_MissionId ) == 0 then				--Èç¹û½øÈë¸±±¾Ç°É¾³ıÈÎÎñ,ÔòÖ±½Ó´«ËÍ»Ø
		x808033_NotifyTip( sceneId, selfId, "Các hÕ ğã không nh§n nhi®m vø này t× trß¾c" )
		local oldsceneId = LuaFnGetCopySceneData_Param( sceneId, x808033_g_keySD["scn"] )		--È¡ ği¬m¸±±¾Èë¿Ú³¡¾°ºÅ
		x = LuaFnGetCopySceneData_Param( sceneId, x808033_g_keySD["x"] )
		z = LuaFnGetCopySceneData_Param( sceneId, x808033_g_keySD["z"] )
		NewWorld( sceneId, selfId, oldsceneId, x, z )
...
--	end
	...
	if leaveFlag == 1 then
		...
		if leaveTickCount == x808033_g_CloseTick then										--µ¹¼ÆÊ±¼äµ½,´ó¼Ò¶¼³öÈ¥°É
			local oldsceneId = LuaFnGetCopySceneData_Param( sceneId, x808033_g_keySD["scn"] )	--È¡ ği¬m¸±±¾Èë¿Ú³¡¾°ºÅ
		...
		elseif leaveTickCount < x808033_g_CloseTick then
			...
			local strText = format( "Các hÕ s¨ r¶i khöi ğây sau %d giây!", (x808033_g_CloseTick-leaveTickCount) * x808033_g_TickTime )
	...
	elseif TickCount == x808033_g_LimitTimeSuccess then
		...
		for	i=0, membercount-1 do
			...
			DelMission( sceneId, mems[i], x808033_g_MissionId )
				...
				x808033_NotifyTip( sceneId, mems[i], "Các hÕ s¨ r¶i khöi ğây sau %d giây!" )
				...
				--Íê³É¸±±¾ËùÓÃÊ±¼ä
				SetMissionByIndex( sceneId, mems[i], misIndex, x808033_g_Param_time, TickCount * x808033_g_TickTime )	--ÉèÖÃÈÎÎñÊı¾İ
			end
		end

		--ÉèÖÃ¸±±¾¹Ø±Õ±êÖ¾
		LuaFnSetCopySceneData_Param( sceneId, x808033_g_keySD["cls"], 1 )
	elseif TickCount == x808033_g_LimitTotalHoldTime then						--¸±±¾×ÜÊ±¼äÏŞÖÆµ½ÁË
		--´Ë´¦ÉèÖÃ¸±±¾ÈÎÎñÓĞÊ±¼äÏŞÖÆtoÕ ğµ Çé¿ö,µ±Ê±¼äµ½ºó´¦Àí...
		for	i=0, membercount-1 do
			if LuaFnIsObjValid( sceneId, mems[i] ) == 1 then
				DelMission( sceneId, mems[i], x808033_g_MissionId )				--ÈÎÎñth¤t bÕi,É¾³ıÖ®
				x808033_NotifyTip( sceneId, mems[i], "Th¶i gian hoàn t¤t nhi®m vø ğã t¾i, hoàn thành!" )
			end
		end
		...
		local oldteamid = LuaFnGetCopySceneData_Param( sceneId, x808033_g_keySD["tem"] )		--È¡ ği¬m±£´ætoÕ ğµ ¶ÓÎéºÅ
		local oldsceneId = LuaFnGetCopySceneData_Param( sceneId, x808033_g_keySD["scn"] )	--È¡ ği¬m¸±±¾Èë¿Ú³¡¾°ºÅ
		...
		for	i=0, membercount-1 do
			if LuaFnIsObjValid( sceneId, mems[i] ) == 1 and IsHaveMission( sceneId, mems[i], x808033_g_MissionId ) > 0 then
				if oldteamid ~= GetTeamId( sceneId, mems[i] ) then
					DelMission( sceneId, mems[i], x808033_g_MissionId )			--ÈÎÎñth¤t bÕi,É¾³ıÖ®
					x808033_NotifyTip( sceneId, mems[i], "Nhi®m vø th¤t bÕi, quá gi¶!" )
