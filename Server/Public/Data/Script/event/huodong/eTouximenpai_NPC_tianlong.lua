...
x808029_g_Param_IsMissionOkFail	= 0						--0ºÅ: µ±Ç°ÈÎÎñĞúng·ñÍê³É(0Î´Íê³É£»1Íê³É)
x808029_g_Param_killmonstercount	= 1					--1ºÅ: É±ËÀÈÎÎñĞ¡¹ÖtoÕ ğµ ÊıÁ¿
x808029_g_Param_killbosscount	= 2							--2ºÅ: É±ËÀÈÎÎñboss¹ÖtoÕ ğµ ÊıÁ¿
x808029_g_Param_sceneid		= 3									--3ºÅ: µ±Ç°¸±±¾ÈÎÎñtoÕ ğµ ³¡¾°ºÅ
x808029_g_Param_teamid		= 4									--4ºÅ: ½Ó¸±±¾ÈÎÎñÊ±ºòtoÕ ğµ ¶ÓÎéºÅ
x808029_g_Param_time			= 5									--5ºÅ: Íê³É¸±±¾ËùÓÃÊ±¼ä(µ¥Î»:  giây)
																							--6ºÅ: ¾ßÌå¸±±¾ÊÂ¼ş½Å±¾Õ¼ÓÃ
																							--7ºÅ: ¾ßÌå¸±±¾ÊÂ¼ş½Å±¾Õ¼ÓÃ
--MisDescEnd
--************************************************************************

x808029_g_CopySceneType			= FUBEN_TIANLONG1	--¸±±¾ÀàĞÍ,¶¨ÒåTÕi ScriptGlobal.luaÀïÃæ
x808029_g_LimitMembers			= 1		--¿ÉÒÔ½ø¸±±¾toÕ ğµ ×îĞ¡¶ÓÎéÈËÊı
x808029_g_TickTime					= 5		--»Øµ÷½Å±¾toÕ ğµ Ê±ÖÓÊ±¼ä(µ¥Î»:  giây/´Î)
x808029_g_LimitTotalHoldTime= 360	--¸±±¾¿ÉÒÔ´æ»îtoÕ ğµ Ê±¼ä(µ¥Î»: ´ÎÊı),Èç¹û´ËÊ±¼äµ½ÁË,ÔòÈÎÎñ½«»áth¤t bÕi
x808029_g_LimitTimeSuccess	= 500	--¸±±¾Ê±¼äÏŞÖÆ(µ¥Î»: ´ÎÊı),Èç¹û´ËÊ±¼äµ½ÁË,ÈÎÎñÍê³É
x808029_g_CloseTick					= 6		--¸±±¾¹Ø±ÕÇ°µ¹¼ÆÊ±(µ¥Î»: ´ÎÊı)
x808029_g_NoUserTime				= 300	--¸±±¾ÖĞÃ»ÓĞÈËºó¿ÉÒÔ¼ÌĞø±£´ætoÕ ğµ Ê±¼ä(µ¥Î»:  giây)
x808029_g_Fuben_X						= 96	--½øÈë¸±±¾toÕ ğµ Î»ÖÃX
x808029_g_Fuben_Z						= 139	--½øÈë¸±±¾toÕ ğµ Î»ÖÃZ
x808029_g_Back_X						= 96	--Ô´³¡¾°Î»ÖÃX
x808029_g_Back_Z						= 139	--Ô´³¡¾°Î»ÖÃZ
x808029_g_Totalkillmonstercount	= 30	--C¥n É±ËÀmonsterÊıÁ¿
x808029_g_Totalkillbosscount	= 1	--C¥n É±ËÀBossÊıÁ¿
...
x808029_g_keySD["x"]	= 7			--ÈËÎïTÕi Èë¿Ú³¡¾°ÖĞtoÕ ğµ xÎ»ÖÃ
x808029_g_keySD["z"]	= 8			--ÈËÎïTÕi Èë¿Ú³¡¾°ÖĞtoÕ ğµ zÎ»ÖÃ
x808029_g_keySD["killedmonsternum"]	= 9		--É±ËÀà¶ÂŞtoÕ ğµ ÊıÁ¿
x808029_g_keySD["killedbossnum"]	= 10		--É±ËÀBosstoÕ ğµ ÊıÁ¿
x808029_g_keySD["mp"]	= 11		--¼ÇÂ¼µ±Ç°¸±±¾toÕ ğµ  ÃÅÅÉ
...
function x808029_OnEnumerate( sceneId, selfId, targetId )
	...
	if GetTeamSize( sceneId, selfId ) < x808029_g_LimitMembers then
	  x808029_NotifyTip( sceneId, selfId, "Mu¯n thØ thách ta chí ít cûng phäi t¾i "..x808029_g_LimitMembers.." ngß¶i. Có tí ngß¶i thª này, quá coi thß¶ng ta" )
	  return
	end
	--PrintNum(4)
...
function x808029_OnAbandon( sceneId, selfId )
	...
	local oldsceneId = LuaFnGetCopySceneData_Param( sceneId, x808029_g_keySD["scn"] )	--È¡ ği¬m¸±±¾Èë¿Ú³¡¾°ºÅ
...
function x808029_OnKillObject( sceneId, selfId, objdataId, objId )
	...
	local killedmonsternumber = LuaFnGetCopySceneData_Param( sceneId, x808029_g_keySD["killedmonsternum"] )			--É±ËÀmonstertoÕ ğµ ÊıÁ¿
	local killedbossnumber = LuaFnGetCopySceneData_Param( sceneId, x808029_g_keySD["killedbossnum"] )			--É±ËÀbosstoÕ ğµ ÊıÁ¿
	...
	if(MonsterName == "Lâu La")then
		...
		LuaFnSetCopySceneData_Param( sceneId, x808029_g_keySD["killedmonsternum"], killedmonsternumber )					--ÉèÖÃÉ±ËÀmonstertoÕ ğµ ÊıÁ¿
		isBoss = 0
	...
	elseif ( MonsterName == "Ác Bá" ) then
		...
		LuaFnSetCopySceneData_Param( sceneId, x808029_g_keySD["killedbossnum"], killedbossnumber )					--ÉèÖÃÉ±ËÀbosstoÕ ğµ ÊıÁ¿
		isBoss = 1
	end
	...
	if (killedmonsternumber < x808029_g_Totalkillmonstercount ) or (killedbossnumber < x808029_g_Totalkillbosscount )then
		...
		for i=0, num-1 do
			...
			if LuaFnIsObjValid( sceneId, humanObjId ) == 1 and LuaFnIsCanDoScriptLogic( sceneId, humanObjId ) == 1 then					--²»TÕi ³¡¾°toÕ ğµ ²»×ö´Ë²Ù×÷
				...
				misIndex = GetMissionIndexByID( sceneId, humanObjId, x808029_g_MissionId )					--È¡ ği¬mÈÎÎñÊı¾İË÷ÒıÖµ
...
--	end
	...
	elseif TickCount == x808029_g_LimitTotalHoldTime then						--¸±±¾×ÜÊ±¼äÏŞÖÆµ½ÁË
		...
		for	i=0, membercount-1 do
			if LuaFnIsObjValid( sceneId, mems[i] ) == 1 then
				DelMission( sceneId, mems[i], x808029_g_MissionId )				--ÈÎÎñth¤t bÕi,É¾³ıÖ®
		...
		local oldteamid = LuaFnGetCopySceneData_Param( sceneId, x808029_g_keySD["tem"] )		--È¡ ği¬m±£´ætoÕ ğµ ¶ÓÎéºÅ
		local oldsceneId = LuaFnGetCopySceneData_Param( sceneId, x808029_g_keySD["scn"] )	--È¡ ği¬m¸±±¾Èë¿Ú³¡¾°ºÅ
