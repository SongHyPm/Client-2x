...
function x808008_OnRefreshGuildContriTitle( sceneId, selfId, targetId )
  ...
  if GetGuildLevel( sceneId, selfId ) < 0 then
	...
	--¾ôÎ»³ÆºÅÐúng·ñÕýÈ·: ²»ÓÃ¸Ä»òÕßÒÑ¾­¸Ä¹ýÁË
	if i ~= nil then 
...
function x808008_IsCanChangeUserName( sceneId, selfId )
	...
	if i == nil then
		x808008_MsgBox( sceneId, selfId, "Các hÕ không phäi là ngß¶i di dân, ho£c các hÕ ðã t×ng sØa ð±i tên" )
		return 0
	end
